...
public class Episode_Details_output {
    ...
    public String getSeason_total_duration() {
        return season_total_duration;
    }

    public void setSeason_total_duration(String season_total_duration) {
        this.season_total_duration = season_total_duration;
    }
