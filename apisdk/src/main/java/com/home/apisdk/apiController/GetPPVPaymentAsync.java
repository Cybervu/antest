...
public class GetPPVPaymentAsync extends AsyncTask<RegisterUserPaymentInputModel, Void, Void> {
    ...
    protected Void doInBackground(RegisterUserPaymentInputModel... params) {
        ...
        try {
            ...
            httppost.addHeader(HeaderConstants.IS_SAVE_THIS_CARD, this.registerUserPaymentInputModel.getIs_save_this_card().trim());
            httppost.addHeader(HeaderConstants.IS_ADVANCE, this.registerUserPaymentInputModel.getIs_advance().trim());
            httppost.addHeader(HeaderConstants.MOVIE_ID, this.registerUserPaymentInputModel.getMovie_id().trim());
