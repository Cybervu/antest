...
public class GetFeatureContentAsynTask extends AsyncTask<FeatureContentInputModel, Void, Void> {
   ...
   /* public class GetContentListAsync extends AsyncTask<Void, Void, Void> {*/
        ...
        public GetFeatureContentAsynTask(FeatureContentInputModel featureContentInputModel, Context context) {
            this.listener = (GetFeatureContent) context;
        ...
        protected Void doInBackground(FeatureContentInputModel... params) {
            ...
            try {
                ...
                HttpPost httppost = new HttpPost(APIUrlConstant.GET_FEATURE_CONTENT_URL);
