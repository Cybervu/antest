...
public class GetContentDetailsAsynTask extends AsyncTask<ContentDetailsInput, Void, Void> {
   ...
   /* public class GetContentListAsync extends AsyncTask<Void, Void, Void> {*/
        ...
        public GetContentDetailsAsynTask(ContentDetailsInput contentDetailsInput, Context context) {
            this.listener = (GetContentDetails)context;
        ...
        protected Void doInBackground(ContentDetailsInput... params) {
            ...
            try {
                ...
                HttpPost httppost = new HttpPost(APIUrlConstant.CONTENT_DETAILS_URL);
