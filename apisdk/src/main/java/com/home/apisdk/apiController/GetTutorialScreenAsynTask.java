...
import com.home.apisdk.apiModel.TutorialScreenInput;
 ...
 * @author MUVI
 */
public class GetTutorialScreenAsynTask extends AsyncTask<ContentListInput, Void, Void> {

    private TutorialScreenInput tutorialScreenInput;
    ...
    public interface GetContentListListener {
        ...
        void onGetTutorialScreenPreExecuteStarted();
        ...
        void onGetTutorialScreenPostExecuteCompleted(ArrayList<ContentListOutput> contentListOutputArray, int status,  String message);
    }
     ...
     *
     * @param tutorialScreenInput A Model Class which is use for background task, we need to set all the attributes through setter methods of input model class,
    ...
    public GetTutorialScreenAsynTask(TutorialScreenInput tutorialScreenInput, GetContentListListener listener, Context context) {
        this.listener = listener;
        this.context = context;


        this.tutorialScreenInput = tutorialScreenInput;
    ...
    protected Void doInBackground(ContentListInput... params) {
        ...
        try {
            ...
            HttpPost httppost = new HttpPost(APIUrlConstant.getTutorialScreen());
            httppost.setHeader(HTTP.CONTENT_TYPE, "application/x-www-form-urlencoded;charset=UTF-8");

            httppost.addHeader(HeaderConstants.AUTH_TOKEN, this.tutorialScreenInput.getAuthToken());
            httppost.addHeader(HeaderConstants.PERMALINK, this.tutorialScreenInput.getApp_type());
    ...
    protected void onPreExecute() {
        super.onPreExecute();
        listener.onGetTutorialScreenPreExecuteStarted();
        responseStr = "0";
        status = 0;
        if (!PACKAGE_NAME.equals(SDKInitializer.getUser_Package_Name_At_Api(context))) {
            this.cancel(true);
            message = "Packge Name Not Matched";
            listener.onGetTutorialScreenPostExecuteCompleted(contentListOutput, status,  message);
            return;
        }
