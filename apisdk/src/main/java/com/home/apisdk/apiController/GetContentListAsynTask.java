...
public class GetContentListAsynTask extends AsyncTask<ContentListInput, Void, Void> {
   ...
   /* public class GetContentListAsync extends AsyncTask<Void, Void, Void> {*/
        ...
        public GetContentListAsynTask(ContentListInput contentListInput,Context context) {
            this.listener = (GetContentList) context;
        ...
        protected Void doInBackground(ContentListInput... params) {
            ...
            try {
                ...
                HttpPost httppost = new HttpPost(APIUrlConstant.GET_CONTENT_LIST_URL);
