package com.muvi.muviplayersdk.adapter;
 ...
 */
public class SdkMyDownloadAdapter extends BaseAdapter {
    SdkMyDownloads activity;
    ArrayList<ContactModel1> downloadModel;
    ContactModel1 audio;
    DBHelper dbHelper;
    DownloadManager downloadManager;
    public SdkMyDownloadAdapter(SdkMyDownloads activity , ArrayList<ContactModel1> downloadModel) {
