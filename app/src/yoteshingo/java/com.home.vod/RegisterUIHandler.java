...
public class RegisterUIHandler {
    ...
    public RegisterUIHandler(Activity context){
        ...
        editphone = (EditText) context.findViewById(R.id.editphone);
    ...
    public void setTermsTextView(LanguagePreference languagePreference){
        ...
        FontUtls.loadFont(context,context.getResources().getString(R.string.light_fonts),editphone);
        editName.setHint(languagePreference.getTextofLanguage(NAME_HINT, DEFAULT_NAME_HINT));
        editphone.setHint(languagePreference.getTextofLanguage(MOBILE,DEFAULT_MOBILE));
        ...
        termsTextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.yoteshin.tv/terms-conditions"));
                browserIntent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                context.startActivity(browserIntent);
            }
        });
   } public void getRegisterName(){
        regPhone = editphone.getText() .toString().trim();
