...
public class FavoriteFragmentAdapter1 extends ArrayAdapter<GridItem> {
    ...
    public FavoriteFragmentAdapter1(Activity mActivity, int layoutResourceId, ArrayList<GridItem> data) {
