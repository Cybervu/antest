...
/**
 * Created by Muvi on 21-Dec-17.
 */

public class CustomSearchAdapter extends ArrayAdapter<GridItem> {
    ...
    public CustomSearchAdapter(Context context, int layoutResourceId,
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        VideoFilterAdapter.ViewHolder holder = null;
