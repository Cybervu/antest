...
public class FollowedFragment extends Fragment implements ViewFavouriteAsynTask.ViewFavouriteListener,DeleteFavAsync.DeleteFavListener{
...
*/
    ...
    public void onViewFavouritePostExecuteCompleted(ArrayList<ViewFavouriteOutputModel> viewFavouriteOutputModelArray, int status, int totalItems, String message) {
        ...
        for (int i = 0; i < viewFavouriteOutputModelArray.size(); i++) {
            ...
            if(contentTypesId.trim().equalsIgnoreCase("3") ) {
            ...
            if (firstTime == true) {
                ...
                if ((getResources().getConfiguration().screenLayout & SCREENLAYOUT_SIZE_MASK) == SCREENLAYOUT_SIZE_LARGE) {
                    if (videoWidth > videoHeight) {
                        mGridView.setNumColumns(getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE ? (int) getResources().getInteger(R.integer.fav_configuration_large_horizontal) : (int) getResources().getInteger(R.integer.fav_configuration_large_horizontal));
                    } else {
                        mGridView.setNumColumns(getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE ? (int) getResources().getInteger(R.integer.fav_configuration_large_vertical) : (int) getResources().getInteger(R.integer.fav_configuration_large_vertical));
                    }

                } else if ((getResources().getConfiguration().screenLayout & SCREENLAYOUT_SIZE_MASK) == SCREENLAYOUT_SIZE_NORMAL) {
                    if (videoWidth > videoHeight) {
                        mGridView.setNumColumns(getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE ? (int) getResources().getInteger(R.integer.fav_configuration_normal_horizontal) : (int) getResources().getInteger(R.integer.fav_configuration_normal_horizontal));
                    } else {
                        mGridView.setNumColumns(getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE ? (int) getResources().getInteger(R.integer.fav_configuration_normal_vertical) : (int) getResources().getInteger(R.integer.fav_configuration_normal_vertical));
                    }

                } else if ((getResources().getConfiguration().screenLayout & SCREENLAYOUT_SIZE_MASK) == SCREENLAYOUT_SIZE_SMALL) {

                    mGridView.setNumColumns(getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE ? (int) getResources().getInteger(R.integer.fav_configuration_small_vertical) : (int) getResources().getInteger(R.integer.fav_configuration_small_vertical));


                } else {
                    if (videoWidth > videoHeight) {
                        mGridView.setNumColumns(getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE ? (int) getResources().getInteger(R.integer.fav_configuration_xlarge_horizontal) : (int) getResources().getInteger(R.integer.fav_configuration_xlarge_horizontal));
                    } else {
                        mGridView.setNumColumns(getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE ? (int) getResources().getInteger(R.integer.fav_configuration_xlarge_vertical) : (int) getResources().getInteger(R.integer.fav_configuration_xlarge_vertical));
                    }
