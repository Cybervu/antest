...
*/
        ...
        if (NetworkStatus.getInstance().isConnected(getActivity())) {
            ...
            homePageInputModel.setAuthToken(preferenceManager.getAuthToken());
           // homePageInputModel.setAuthToken(authToken);
    ...
    public void onLoadVideosAsyncPostExecuteCompleted(ArrayList<LoadVideoOutput> loadVideoOutputs, int code, String status) {
        ...
        if (code==200) {
            ...
            if (counter >= 0 && counter < menuList.size() - 1) {
               ...
               loadVideoInput.setAuthToken(preferenceManager.getAuthToken());
              //loadVideoInput.setAuthToken(authToken);
