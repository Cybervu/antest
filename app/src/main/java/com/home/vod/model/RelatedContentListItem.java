...
public class RelatedContentListItem {
...
//		this.rating = rating;
//	}
public RelatedContentListItem(String imageId, String title, String videoType, String videoTypeId, String movieGenre, String videoUrl, String permalink, String isEpisode, String movieUniqueId, String movieStreamUniqueId, int isConverted, int isPPV, int isAPV, String story,String contentId,String contentStreamId) {
	super();
	this.imageId = imageId;
	this.title = title;
	this.videoType = videoType;
