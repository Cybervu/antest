...
import static com.home.vod.R.id.skipButton;
import static com.home.vod.R.id.subscriptionTitleTextView;
...
public class DigiOsmosisSubscriptionActivity extends AppCompatActivity implements GetPlanListAsynctask.GetStudioPlanListsListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FontUtls.loadFont(DigiOsmosisSubscriptionActivity.this, getResources().getString(R.string.regular_fonts),subscriptionTitleTextView);

        subscriptionTitleTextView.setText(languagePreference.getTextofLanguage(SELECT_PLAN,DEFAULT_SELECT_PLAN)+" :");
        FontUtls.loadFont(DigiOsmosisSubscriptionActivity.this, getResources().getString(R.string.regular_fonts),activation_plan);
        activation_plan.setText(languagePreference.getTextofLanguage(ACTIAVTE_PLAN_TITLE,DEFAULT_ACTIAVTE_PLAN_TITLE));
        FontUtls.loadFont(DigiOsmosisSubscriptionActivity.this, getResources().getString(R.string.regular_fonts),skipButton);

        skipButton.setText(languagePreference.getTextofLanguage(SKIP_BUTTON_TITLE,DEFAULT_SKIP_BUTTON_TITLE));


        mLayoutManager = new LinearLayoutManager(DigiOsmosisSubscriptionActivity.this, LinearLayoutManager.VERTICAL, false);
    ...
    public void onGetPlanListPreExecuteStarted() {
        progressBarHandler = new ProgressBarHandler(DigiOsmosisSubscriptionActivity.this);
    ...
    public void onGetPlanListPostExecuteCompleted(ArrayList<SubscriptionPlanOutputModel> planListOutput, int status) {
        ...
        if (status>0){
            ...
            if (status==200){
                ...
                mAdapter = new PlanAdapter(DigiOsmosisSubscriptionActivity.this,movieList);
                ...
                subcription.addOnItemTouchListener(new VideosListFragment.RecyclerTouchListener(DigiOsmosisSubscriptionActivity.this, subcription, new VideosListFragment.ClickListener() {
                    @Override
            ...
            Util.showToast(DigiOsmosisSubscriptionActivity.this,languagePreference.getTextofLanguage(NO_DETAILS_AVAILABLE,DEFAULT_NO_DETAILS_AVAILABLE));
