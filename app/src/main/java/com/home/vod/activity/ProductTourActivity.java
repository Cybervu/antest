...
import com.home.vod.fragment.ProductTourFragment;
...
public class ProductTourActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back = ImageButton.class.cast(findViewById(R.id.back));
    ...
    private void setIndicator(int index){
        if(index < NUM_PAGES){
            for(int i = 0 ; i < NUM_PAGES - 1 ; i++){
                ...
                circle.setPadding(padding, 0, padding, 0);
                if(i == index){
                	circle.setColorFilter(getResources().getColor(R.color.buttonTextColor));
                }else {
