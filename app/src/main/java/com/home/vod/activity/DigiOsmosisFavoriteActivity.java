...
public class DigiOsmosisFavoriteActivity extends AppCompatActivity implements GetLanguageListAsynTask.GetLanguageListListener,ViewFavouriteAsynTask.ViewFavouriteListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FontUtls.loadFont(DigiOsmosisFavoriteActivity.this, getResources().getString(R.string.regular_fonts),sectionTitle);
        ...
        posterUrl = Util.getTextofLanguage(DigiOsmosisFavoriteActivity.this, Util.NO_DATA, Util.DEFAULT_NO_DATA);
        ...
        noInternetTextView.setText(Util.getTextofLanguage(DigiOsmosisFavoriteActivity.this, Util.NO_INTERNET_CONNECTION, Util.DEFAULT_NO_INTERNET_CONNECTION));
        noDataTextView.setText(Util.getTextofLanguage(DigiOsmosisFavoriteActivity.this, Util.NO_CONTENT, Util.DEFAULT_NO_CONTENT));
            ...
            public boolean onItemLongClick(AdapterView<?> adapterView, View view, int i, long l) {
              ...
              /*  Log.v("SUBHAlaxmi","GG"+i+customGridAdapter.getItem(i).isSelected());
                ...
                if (customGridAdapter.getItem(i).isSelected() == false) {
                    Log.v("SUBHAlaxmi","called"+i+customGridAdapter.getItem(i).isSelected());
                    ...
                    Log.v("SUBHAlaxmi","called1"+i+customGridAdapter.getItem(i).isSelected());
            ...
            public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
                ...
                if (scrolling == true && mIsScrollingUp == false) {
                    ...
                    if (firstVisibleItem + visibleItemCount >= totalItemCount) {
                        ...
                        offset += 1;
                        boolean isNetwork = Util.checkNetwork(DigiOsmosisFavoriteActivity.this);
                        if (isNetwork == true) {
    ...
    public void onGetLanguageListPreExecuteStarted() {
        ...
        progressBarHandler = new ProgressBarHandler(DigiOsmosisFavoriteActivity.this);
    ...
    public void onLogoutPreExecuteStarted() {
        pDialog = new ProgressBarHandler(DigiOsmosisFavoriteActivity.this);
        pDialog.show();
    }
    ...
    public void onLogoutPostExecuteCompleted(int code, String status, String message) {
        ...
        if (status == null) {
            Toast.makeText(DigiOsmosisFavoriteActivity.this, languagePreference.getTextofLanguage(SIGN_OUT_ERROR, DEFAULT_SIGN_OUT_ERROR), Toast.LENGTH_LONG).show();
        ...
        if (code > 0) {
            if (code == 200) {
                ...
                if ((languagePreference.getTextofLanguage(IS_ONE_STEP_REGISTRATION,DEFAULT_IS_ONE_STEP_REGISTRATION)
                        .trim()).equals("1")) {
                    final Intent startIntent = new Intent(DigiOsmosisFavoriteActivity.this, SplashScreen.class);
                    runOnUiThread(new Runnable() {
                        public void run() {
                            startIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                            startIntent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                            startActivity(startIntent);
                            Toast.makeText(DigiOsmosisFavoriteActivity.this, languagePreference.getTextofLanguage(LOGOUT_SUCCESS, DEFAULT_LOGOUT_SUCCESS), Toast.LENGTH_LONG).show();
                            finish();

                        }
                    });
                } else {
                    final Intent startIntent = new Intent(DigiOsmosisFavoriteActivity.this, MainActivity.class);
                    runOnUiThread(new Runnable() {
                        public void run() {
                            startIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                            startIntent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
    ...
    public void onDeleteFavPostExecuteCompleted(DeleteFavOutputModel deleteFavOutputModel, int status, String sucessMsg) {
        ...
        if (status==200) {
            ...
            DigiOsmosisFavoriteActivity.this.sucessMsg=sucessMsg;
            showToast();
            ...
            if (firstTime == true) {
                ...
                if ((getResources().getConfiguration().screenLayout & SCREENLAYOUT_SIZE_MASK) == SCREENLAYOUT_SIZE_LARGE) {
                    if (videoWidth > videoHeight) {
                        gridView.setNumColumns(getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE ? (int) getResources().getInteger(R.integer.fav_configuration_large_horizontal) : (int) getResources().getInteger(R.integer.fav_configuration_large_horizontal));
                    } else {
                        gridView.setNumColumns(getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE ? (int) getResources().getInteger(R.integer.fav_configuration_large_vertical) : (int) getResources().getInteger(R.integer.fav_configuration_large_vertical));
                    }

                } else if ((getResources().getConfiguration().screenLayout & SCREENLAYOUT_SIZE_MASK) == SCREENLAYOUT_SIZE_NORMAL) {
                    if (videoWidth > videoHeight) {
                        gridView.setNumColumns(getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE ? (int) getResources().getInteger(R.integer.fav_configuration_normal_horizontal) : (int) getResources().getInteger(R.integer.fav_configuration_normal_horizontal));
                    } else {
                        gridView.setNumColumns(getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE ? (int) getResources().getInteger(R.integer.fav_configuration_normal_vertical) : (int) getResources().getInteger(R.integer.fav_configuration_normal_vertical));
                    }

                } else if ((getResources().getConfiguration().screenLayout & SCREENLAYOUT_SIZE_MASK) == SCREENLAYOUT_SIZE_SMALL) {

                    gridView.setNumColumns(getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE ? (int) getResources().getInteger(R.integer.fav_configuration_small_vertical) : (int) getResources().getInteger(R.integer.fav_configuration_small_vertical));


                } else {
                    if (videoWidth > videoHeight) {
                        gridView.setNumColumns(getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE ? (int) getResources().getInteger(R.integer.fav_configuration_xlarge_horizontal) : (int) getResources().getInteger(R.integer.fav_configuration_xlarge_horizontal));
                    } else {
                        gridView.setNumColumns(getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE ? (int) getResources().getInteger(R.integer.fav_configuration_xlarge_vertical) : (int) getResources().getInteger(R.integer.fav_configuration_xlarge_vertical));
                    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_search:
                final Intent searchIntent = new SearchIntentHandler(DigiOsmosisFavoriteActivity.this).handleSearchIntent();
            ...
            case R.id.action_login:
                ...
                Intent loginIntent = new Intent(DigiOsmosisFavoriteActivity.this, LoginActivity.class);
            ...
            case R.id.action_register:
                ...
                Intent registerIntent = new Intent(DigiOsmosisFavoriteActivity.this, RegisterActivity.class);
                Util.check_for_subscription = 0;
...
//                favoriteIntent.putExtra("LOGID",id);
            ...
            case R.id.menu_item_profile:
                ...
                Intent profileIntent = new Intent(DigiOsmosisFavoriteActivity.this, ProfileActivity.class);
            ...
            case R.id.action_purchage:
                ...
                Intent purchaseintent = new Intent(DigiOsmosisFavoriteActivity.this, PurchaseHistoryActivity.class);
                startActivity(purchaseintent);
                // Not implemented here
                return false;
            case R.id.action_logout:

                AlertDialog.Builder dlgAlert = new AlertDialog.Builder(DigiOsmosisFavoriteActivity.this, R.style.MyAlertDialogStyle);
                dlgAlert.setMessage(Util.getTextofLanguage(DigiOsmosisFavoriteActivity.this, Util.SIGN_OUT_WARNING, Util.DEFAULT_SIGN_OUT_WARNING));
                dlgAlert.setTitle("");

                dlgAlert.setPositiveButton(Util.getTextofLanguage(DigiOsmosisFavoriteActivity.this, Util.YES, Util.DEFAULT_YES), new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        logoutInput.setLang_code(Util.getTextofLanguage(DigiOsmosisFavoriteActivity.this, Util.SELECTED_LANGUAGE_CODE, DEFAULT_SELECTED_LANGUAGE_CODE));
                        LogoutAsynctask asynLogoutDetails = new LogoutAsynctask(logoutInput, DigiOsmosisFavoriteActivity.this, DigiOsmosisFavoriteActivity.this);
                ...
                dlgAlert.setNegativeButton(Util.getTextofLanguage(DigiOsmosisFavoriteActivity.this, Util.NO, Util.DEFAULT_NO), new DialogInterface.OnClickListener() {
    ...
    public void ShowLanguagePopup() {
        ...
        final AlertDialog.Builder alertDialog = new AlertDialog.Builder(DigiOsmosisFavoriteActivity.this, R.style.MyAlertDialogStyle);
        ...
        titleTextView.setText(Util.getTextofLanguage(DigiOsmosisFavoriteActivity.this, Util.APP_SELECT_LANGUAGE, Util.DEFAULT_APP_SELECT_LANGUAGE));
        ...
        apply.setText(Util.getTextofLanguage(DigiOsmosisFavoriteActivity.this, Util.BUTTON_APPLY, Util.DEFAULT_BUTTON_APPLY));
...
*/
        recyclerView.addOnItemTouchListener(new MovieDetailsActivity.RecyclerTouchListener1(DigiOsmosisFavoriteActivity.this, recyclerView, new MovieDetailsActivity.ClickListener1() {
            @Override
            public void onClick(View view, int position) {
                ...
                Util.setLanguageSharedPrefernce(DigiOsmosisFavoriteActivity.this, Util.SELECTED_LANGUAGE_CODE, Util.languageModel.get(position).getLanguageId());
        ...
        apply.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!Previous_Selected_Language.equals(Default_Language)) {
                    ...
                    GetTranslateLanguageAsync getTranslateLanguageAsync = new GetTranslateLanguageAsync(languageListInputModel,DigiOsmosisFavoriteActivity.this,DigiOsmosisFavoriteActivity.this);
        ...
        alert.setOnDismissListener(new DialogInterface.OnDismissListener() {
            ...
            public void onDismiss(DialogInterface dialog) {
                Util.setLanguageSharedPrefernce(DigiOsmosisFavoriteActivity.this, Util.SELECTED_LANGUAGE_CODE, Previous_Selected_Language);
            }
        });
    ...
    public  void removeFavorite(GridItem gridItem,int pos){
        ...
        DeleteFavAsync deleteFavAsync = new DeleteFavAsync(deleteFavInputModel,DigiOsmosisFavoriteActivity.this,DigiOsmosisFavoriteActivity.this);
