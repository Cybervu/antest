...
/*    private class AsynValidateUserDetails extends AsyncTask<Void, Void, Void> {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        final String loginHistoryIdStr = pref.getString("PREFS_LOGIN_HISTORYID_KEY", null);
        switch (item.getItemId()) {
            ...
            case R.id.menu_item_language:
                ...
                if (Util.languageModel != null && Util.languageModel.size() > 0) {
                    ...
                    GetLanguageListAsynTask asynGetLanguageList = new GetLanguageListAsynTask(languageListInputMode,this);
            ...
            case R.id.action_logout:
                ...
                dlgAlert.setPositiveButton(Util.getTextofLanguage(Episode_list_Activity.this, Util.YES, Util.DEFAULT_YES), new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        LogoutAsynctask asynLogoutDetails = new LogoutAsynctask(logoutInput,Episode_list_Activity.this);
