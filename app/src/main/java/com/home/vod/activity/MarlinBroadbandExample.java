...
//        asynGetIpAddress.executeOnExecutor(threadPoolExecutor);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(getIntent().getStringExtra("story")!=null && !getIntent().getStringExtra("story").matches("")) {
            storyStr = getIntent().getStringExtra("story").trim();
        }
...
//        download_content_type = getIntent().getStringExtra("download_content_type");
        ...
        storyTextView = (TextView) findViewById(R.id.story);
        ...
        if (storyStr != null && !storyStr.matches(""))
        {
            storyTextView.setText(storyStr);
